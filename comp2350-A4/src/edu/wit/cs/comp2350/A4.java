...
// Program: Algorithms Assignment 4
// Purpose: To understand the program I am assigned to complete.

// LinkedLists are complex, but not really, so you need to understand them. 
...
public class A4 {
	...
	public static void main(String[] args) {
		// This section of code creates a scanner which is delimited, and l, which is a Binary Search Tree.
		Scanner s = new Scanner(System.in);	s.useDelimiter("(\\s|,)+");	//delimit with commas
		LocationHolder l = new BST();

		System.out.printf("Enter the data structure to use ([l]ist, [b]inary tree): ");
		char algo = s.next().charAt(0);
		
		// If user inputs l, l becomes a list. If user inputs b, l becomes a Binary Sorting Tree. Else, "Invalid Data Structure."
		switch (algo) {
		case 'l':
			l = new L();
			break;
